            ...
            tumor_adjusted  = ADJUST_BAM_RG_TUMOR
                              ...
                              .map{ it ->
                                    [
                                        ...
                                        [tumor_bam: it[1].tumor_bam, tumor_bai: it[2].tumor_bai ]
                                    ]
                                   }
             ...
             normal_adjusted  = ADJUST_BAM_RG_NORMAL
                              ...
                              .map{ it ->
                                    [
                                        [sample_name: it[0].sample_name ],
                                        [normal_bam: it[1].normal_bam, normal_bai: it[2].normal_bai ]
                                    ]
                                   }

            input_calling   =  (normal_adjusted.join(tumor_adjusted, failOnMismatch:true)).view()
        }
        VARIANT_CALLING(
            input_calling,
            germline_resource,
